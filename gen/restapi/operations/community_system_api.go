...
func NewCommunitySystemAPI(spec *loads.Document) *CommunitySystemAPI {
	return &CommunitySystemAPI{
		...
		MeetupGetMeetupHandler: meetup.GetMeetupHandlerFunc(func(params meetup.GetMeetupParams) middleware.Responder {
		...
		SpeakerGetSpeakersHandler: speaker.GetSpeakersHandlerFunc(func(params speaker.GetSpeakersParams) middleware.Responder {
			return middleware.NotImplemented("operation speaker.GetSpeakers has not yet been implemented")
		}),
...
/*CommunitySystemAPI Community-system is an system to manage community. */
type CommunitySystemAPI struct {
	spec            *loads.Document
	...
	// MeetupGetMeetupHandler sets the operation handler for the get meetup operation
	...
	// SpeakerGetSpeakersHandler sets the operation handler for the get speakers operation
...
func (o *CommunitySystemAPI) UseRedoc() {
	o.useSwaggerUI = false
}

// UseSwaggerUI for documentation at /docs
func (o *CommunitySystemAPI) UseSwaggerUI() {
	o.useSwaggerUI = true
}

// SetDefaultProduces sets the default produces media type
func (o *CommunitySystemAPI) SetDefaultProduces(mediaType string) {
	o.defaultProduces = mediaType
}

// SetDefaultConsumes returns the default consumes media type
func (o *CommunitySystemAPI) SetDefaultConsumes(mediaType string) {
	o.defaultConsumes = mediaType
}

// SetSpec sets a spec that will be served for the clients.
func (o *CommunitySystemAPI) SetSpec(spec *loads.Document) {
	o.spec = spec
}

// DefaultProduces returns the default produces media type
func (o *CommunitySystemAPI) DefaultProduces() string {
	return o.defaultProduces
}

// DefaultConsumes returns the default consumes media type
func (o *CommunitySystemAPI) DefaultConsumes() string {
	return o.defaultConsumes
}

// Formats returns the registered string formats
func (o *CommunitySystemAPI) Formats() strfmt.Registry {
	return o.formats
}

// RegisterFormat registers a custom format validator
func (o *CommunitySystemAPI) RegisterFormat(name string, format strfmt.Format, validator strfmt.Validator) {
	o.formats.Add(name, format, validator)
}

// Validate validates the registrations in the CommunitySystemAPI
func (o *CommunitySystemAPI) Validate() error {
	...
	if o.MeetupGetMeetupHandler == nil {
		unregistered = append(unregistered, "meetup.GetMeetupHandler")
	}
	if o.MeetupGetMeetupsHandler == nil {
		unregistered = append(unregistered, "meetup.GetMeetupsHandler")
	}
	if o.SpeakerGetSpeakersHandler == nil {
		unregistered = append(unregistered, "speaker.GetSpeakersHandler")
	}
...
func (o *CommunitySystemAPI) ServeErrorFor(operationID string) func(http.ResponseWriter, *http.Request, error) {
	return o.ServeError
}

// AuthenticatorsFor gets the authenticators for the specified security schemes
func (o *CommunitySystemAPI) AuthenticatorsFor(schemes map[string]spec.SecurityScheme) map[string]runtime.Authenticator {
	return nil
}

// Authorizer returns the registered authorizer
func (o *CommunitySystemAPI) Authorizer() runtime.Authorizer {
	return nil
}

// ConsumersFor gets the consumers for the specified media types.
// MIME type parameters are ignored here.
func (o *CommunitySystemAPI) ConsumersFor(mediaTypes []string) map[string]runtime.Consumer {
...
// MIME type parameters are ignored here.
func (o *CommunitySystemAPI) ProducersFor(mediaTypes []string) map[string]runtime.Producer {
...
func (o *CommunitySystemAPI) HandlerFor(method, path string) (http.Handler, bool) {
	if o.handlers == nil {
		return nil, false
	}
...
// Context returns the middleware context for the community system API
func (o *CommunitySystemAPI) Context() *middleware.Context {
	if o.context == nil {
...
func (o *CommunitySystemAPI) initHandlerCache() {
	...
	o.handlers["GET"]["/meetups/{meetup_id}"] = meetup.NewGetMeetup(o.context, o.MeetupGetMeetupHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	...
	o.handlers["GET"]["/meetups/{meetup_id}/speakers"] = speaker.NewGetSpeakers(o.context, o.SpeakerGetSpeakersHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	...
	o.handlers["PATCH"]["/meetups/sponsors/{sponsor_id}"] = sponsor.NewPatchSponsor(o.context, o.SponsorPatchSponsorHandler)
	...
	o.handlers["PUT"]["/meetups/{meetup_id}/speakers"] = speaker.NewPutSpeaker(o.context, o.SpeakerPutSpeakerHandler)
	if o.handlers["PUT"] == nil {
		o.handlers["PUT"] = make(map[string]http.Handler)
	}
...
func (o *CommunitySystemAPI) Serve(builder middleware.Builder) http.Handler {
	o.Init()
...
func (o *CommunitySystemAPI) Init() {
	if len(o.handlers) == 0 {
		o.initHandlerCache()
	}
}
...
func (o *CommunitySystemAPI) RegisterConsumer(mediaType string, consumer runtime.Consumer) {
	o.customConsumers[mediaType] = consumer
}

// RegisterProducer allows you to add (or override) a producer for a media type.
func (o *CommunitySystemAPI) RegisterProducer(mediaType string, producer runtime.Producer) {
	o.customProducers[mediaType] = producer
}

// AddMiddlewareFor adds a http middleware to existing handler
func (o *CommunitySystemAPI) AddMiddlewareFor(method, path string, builder middleware.Builder) {
	um := strings.ToUpper(method)
	if path == "/" {
		path = ""
	}
