...
func (o *PatchMeetupURL) Build() (*url.URL, error) {
	...
	if meetupID != "" {
		...
		return nil, errors.New("meetupId is required on PatchMeetupURL")
	}
...
func (o *PatchMeetupURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PatchMeetupURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PatchMeetupURL")
	}
